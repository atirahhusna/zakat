                                    ...
                                    <form method="POST" action="earning.php">
                                        <div class="container mt-5">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                RM<input type="number" step="0.01" required class="form-control" id="month" name="month" placeholder="Enter monthly income (e.g., 45000)" oninput="calculateYearlyIncome(); calculateTotalIncome();">
                                            </div>

                                            <!-- Yearly income -->
                                            <div class="form-group mb-3">
                                                <label for="year">Yearly Income</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="year" name="year" readonly>
                                            </div>

                                            <!-- Other income -->
                                            <div class="form-group mb-3">
                                                <label for="others">Other Income</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="others" name="others" placeholder="Enter other income (e.g., 45000)" oninput="calculateTotalIncome();">
                                            </div>

                                            <!-- Total income -->
                                            <div class="form-group mb-3">
                                                <label for="total">Total Income</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="total" name="total" readonly>
                                            </div>

                                            <hr><b>Yearly Expenses Information</b><hr>

                                            <!-- Self expenses -->
                                            <div class="form-group mb-3">
                                                <label for="self">Self Expenses</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="self" name="self" placeholder="Enter self expenses (e.g., 45000)">
                                            </div>

                                            <!-- Number of wives -->
                                            <div class="form-group mb-3">
                                                <label for="wife">Number of Wives</label>
                                                <input type="number" required class="form-control" id="wife" name="wife" placeholder="Enter number of wives" oninput="calculateWifeExpenses();">
                                            </div>

                                            <!-- Wife expenses -->
                                            <div class="form-group mb-3">
                                                <label for="wifeExpenses">Wife Expenses</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="wifeExpenses" name="wifeExpenses" readonly>
                                            </div>

                                            <!-- Number of children under 18 -->
                                            <div class="form-group mb-3">
                                                <label for="child">Number of Children Under 18</label>
                                                <input type="number" required class="form-control" id="child" name="child" placeholder="Enter number of children under 18" oninput="calculateChildExpenses();">
                                            </div>

                                            <!-- Child expenses under 18 -->
                                            <div class="form-group mb-3">
                                                <label for="childExpenses">Child Expenses Under 18</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="childExpenses" name="childExpenses" readonly>
                                            </div>

                                            <!-- Number of children above 18 pursuing study -->
                                            <div class="form-group mb-3">
                                                <label for="child18">Number of Children Above 18 Pursuing Study</label>
                                                <input type="number" required class="form-control" id="child18" name="child18" placeholder="Enter number of children above 18" oninput="calculateChildExpenses();">
                                            </div>

                                            <!-- Child expenses above 18 -->
                                            <div class="form-group mb-3">
                                                <label for="child18Expenses">Child Expenses Above 18</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="child18Expenses" name="child18Expenses" readonly>
                                            </div>

                                            <!-- Parents -->
                                            <div class="form-group mb-3">
                                                <label for="parents">Parents</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="parents" name="parents">
                                            </div>

                                            <!-- Self study -->
                                            <div class="form-group mb-3">
                                                <label for="selfStudy">Self Study Expenses</label>
                                                RM<input type="number" step="0.01" required class="form-control" id="selfStudy" name="selfStudy">
                                            </div>
